...
object CoGroup_test_normal {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val layered:  RDD[ITile[Array[Float]]] = RasterOperationsLocal.overlay(hrTiles, Landsat)
    ...
    GeoTiffWriter.saveAsGeoTiff(next5, output_file + "/lazyCA_overlayNormal.tif", Seq(GeoTiffWriter.WriteMode -> "compatibility", GeoTiffWriter.OutputNumBands -> "5", GeoTiffWriter.BigTiff -> "yes", GeoTiffWriter.FillValue -> "-9999")) //GeoTiffWriter.BigTiff -> "yes"
  }
}
