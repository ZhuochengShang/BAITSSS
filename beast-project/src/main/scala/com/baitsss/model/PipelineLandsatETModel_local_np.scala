...
object PipelineLandsatETModel_local_np {
  ...
  def processDay(
    ...
    try {
      ...
      val prism_daily = "/Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/PRISM_2019_Geotiff" // Contains daily files, e.g., NLDAS_DAILY.AYYYYMMDD.002.tif
      ...
      val b4Map = findLocalLandsatFiles(
        landsatDate,
        "/Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/landsat8/B4",
        10
      )
      val b5Map = findLocalLandsatFiles(
        landsatDate,
        "/Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/landsat8/B5",
        10
      )
      ...
      val baseKV_full: RDD[(Int, ITile[Array[Float]])] = RasterOperationsLocal.overlayArrayStreamsF2(baseKV, landsKV)

      // Process hourly data
      val dayDir = new File(s"/Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/NLDAS2019_Geotiff_test/$dateStr")
      ...
      val NLDAS_filter = listDateFolders(new Path("/Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/NLDAS2019_Geotiff_test"), FileSystem.get(sc.hadoopConfiguration))
      ...
      for ((path, idx) <- NLDAS_RasterRDD.zipWithIndex) {
        ...
        try {
          ...
          val rawNext = BandCalculationCheck2.IterativeCalculationPre2(layered)
          if (rawNext == null) {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val aoi = sc.shapefile("file:///Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/yuma/YumaAgMain_latlon2.shp") // Update this path
    ...
    val elevRDD = sc.geoTiff[Float]("file:///Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/elev4326.tif") // Update
    val awcRDD = sc.geoTiff[Float]("file:///Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/usa_awc_clip.tif") // Update
    val awcRDD_filter = awcRDD.filterPixels(_ > 0)
    val fcRDD = sc.geoTiff[Float]("file:///Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/usa_fc_clip.tif") // Update
    val fcRDD_filter = fcRDD.filterPixels(_ > 0)
    val nlcdInt = sc.geoTiff[Float]("file:///Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/nlcd/nlcd_clip.tif") // Update
    ...
    val awcKV: RDD[(Int, ITile[Float])] = RasterOperationsFocal.reshapeNN2(awcRDD_filter, _ => aoiMeta, parts, part)//.persist(StorageLevel.DISK_ONLY)
    val fcKV: RDD[(Int, ITile[Float])] = RasterOperationsFocal.reshapeNN2(fcRDD_filter, _ => aoiMeta, parts, part)//.persist(StorageLevel.DISK_ONLY)
    ...
    var curr = LocalDate.parse("2019-09-23")
    val end = LocalDate.parse("2019-09-23")
    var currLandsat = LocalDate.parse("2019-09-23")
    ...
    val ET_Rdd = finalRdd.mapPixels(p=>p(0))
    val output = "file:///Users/clockorangezoe/Documents/phd_projects/code/baitsss_model_fieldsat/data/output"
    val output_file = s"$output/landsat-$star-$endDate.01.tif"
    GeoTiffWriter.saveAsGeoTiff(ET_Rdd, output_file, Seq(
