...
import com.baitsss.model.PipelineLandsatETModel2.getClass
...
object PipelineLandsatETModel3 {
...
//      Thread.sleep(300000) // 5 minutes
      ...
      val b4Map = findLocalLandsatFiles(
        landsatDate,
        "/Users/clockorangezoe/Desktop/BAITSSS_project/testfolder/minnesota/landsat/B4",
        7
      )
      val b5Map = findLocalLandsatFiles(
        landsatDate,
        "/Users/clockorangezoe/Desktop/BAITSSS_project/testfolder/minnesota/landsat/B5",
        7
      )
      ...
      val output_file = s"$output/landsatndvi.mn.tif"
      GeoTiffWriter.saveAsGeoTiff(landsKV.values, output_file, Seq(
        GeoTiffWriter.WriteMode -> "compatibility",
        GeoTiffWriter.OutputNumBands -> "2",
...
//      Thread.sleep(300000) // 5 minutes
      ...
      for ((path, idx) <- tifPaths.slice(0,2).zipWithIndex) {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val aoi = sc.shapefile("file:///Users/clockorangezoe/Desktop/BAITSSS_project/testfolder/minnesota/aoi/POLYGON.shp") // Update this path
    ...
    val elevRDD = sc.geoTiff[Float]("file:///Users/clockorangezoe/Desktop/BAITSSS_project/testfolder/originaldata/NLDAS_elevation.tif").retile(10,10) // Update
