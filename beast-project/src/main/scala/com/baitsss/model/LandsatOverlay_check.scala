  ...
  def main(args: Array[String]): Unit = {
    ...
    println(wholePathStringB5)
      ...
      var hour = 0
        ...
        // val timeStamp = t._1
        val filename = "NLDAS_2023_Geotiff/2023-01-01/NLDAS_FORA0125_H.A20230101.0000.002.tif"
      println(filename)
    ...
    val filterlayer = layer3.filterPixels(value => {
    ...
    val output_file = s"$output/landsat-overlay-$startDate-$endDate.bilinear.tif"
    GeoTiffWriter.saveAsGeoTiff(previousCycle, output_file, Seq(GeoTiffWriter.WriteMode -> "compatibility", GeoTiffWriter.OutputNumBands ->"11", GeoTiffWriter.FillValue -> "-9999")) //GeoTiffWriter.BigTiff -> "yes"
