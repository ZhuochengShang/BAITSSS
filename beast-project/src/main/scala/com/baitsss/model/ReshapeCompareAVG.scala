...
import com.baitsss.model.ReshapeCompareNN.Raster_metadata
...
object ReshapeCompareAVG {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val Planet_RDD_reshape: RasterRDD[Array[Float]] = RasterOperationsFocal.reshapeAverage(PlanetFloat, RasterMetadata => Planet_RDD_Metadata)
    val output_file = s"$output/planet-reshape-one-day-avg.tif"
    ...
    println("Total time of whole process : Reshape AVG rasterRDD: " + (endTime - startTime) / 1E9)
